...
export function Dashboard() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#060606] text-zinc-100">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-4 py-5 sm:px-6 lg:px-8">
        <header className="mb-5 border border-zinc-800 bg-black/45 px-4 py-4 backdrop-blur-[2px]">
